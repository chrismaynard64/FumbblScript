                        ...
                        success:
                                        function (data) {
                                            ...
                                            $(data).each(function (key, val) {
                                                ...
                                                tr.append('<td data-title="Team"><a href="results2020.html?sprintId=' + $("#ddSprint option:selected").val() + '&teamId=' + val['TeamId'] + '">' + val['TeamName'] + '</a></td>');  //2
                                                tr.append('<td data-title="Coach"><a href="https://fumbbl.com/~' + val['CoachName'] + '">' + val['CoachName'] + '</a></td>');  //3
                                                tr.append('<td data-title="Race"><a href="sprint.html?sprintId=' + $("#ddSprint option:selected").val() + '&raceId=' + val['RaceId'] + '">' + val['RaceName'] + '</a></td>'); //4
